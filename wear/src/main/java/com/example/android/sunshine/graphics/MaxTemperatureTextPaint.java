...
public class MaxTemperatureTextPaint extends Paint {
    public static final char DEGREE = (char) 0x00b0;

    private float mXOffset;
    private float mYOffset;

    public MaxTemperatureTextPaint(Context context) {
        super();
        setAntiAlias(true);
        ...
        mXOffset = context.getResources().getDimension(R.dimen.max_temperature_x_offset);
